  ...
  const dishesData1 = [
    {
      ...
      description:
        'Camadas de massa fresca, molho de carne moída, queijo parmesão e molho bechamel gratinado.',
      price: 32.9,
    ...
    },
    {
      ...
      description:
        'Massa com ovos, queijo pecorino, pancetta crocante e pimenta preta moída na hora.',
      price: 28.5,
      categories: ['Massas', 'Prato Principal'],
    },
    {
      ...
      description:
        'Massa fettuccine com mariscos frescos, alho, tomate cereja e ervas finas.',
      price: 35.9,
      categories: ['Massas', 'Prato Principal'],
    },
    {
      ...
      description:
        'Arroz arbóreo cremoso com cogumelos porcini, queijo parmesão e manteiga trufada.',
      price: 38.9,
    ...
    },
    {
      ...
      description:
        'Filé mignon empanado com molho de tomate, mussarela derretida e parmesão.',
      price: 45.9,
    ...
    },
    {
      ...
      description:
        'Costela bovina assada lentamente com temperos especiais e molho barbecue.',
      price: 48.9,
      categories: ['Carnes', 'Prato Principal'],
    },
    {
      name: 'Salada Caprese',
      description:
        'Tomate, mussarela de búfala, manjericão fresco e azeite extra virgem.',
      price: 22.9,
    ...
    },
    {
      ...
      description:
        'Alface romana, croutons, parmesão, molho caesar e filé de frango grelhado.',
      price: 25.9,
      categories: ['Saladas', 'Entrada'],
    },
    {
      ...
      description:
        'Pão italiano torrado com tomate, manjericão, alho e azeite de oliva.',
      price: 18.9,
    ...
    },
    {
      ...
      description:
        'Finas fatias de carne crua com rúcula, parmesão e azeite trufado.',
      price: 32.9,
      categories: ['Petiscos', 'Entrada'],
    },
    {
      ...
      description:
        'Sobremesa italiana com biscoitos embebidos em café, creme de mascarpone e cacau.',
      price: 18.9,
  ...
  const dishesData2 = [
    {
      ...
      description:
        'Pizza tradicional com molho de tomate, mussarela fresca e manjericão.',
      price: 29.9,
    ...
    },
    {
      ...
      description:
        'Lasanha com frango desfiado, milho, catupiry e molho bechamel.',
      price: 30.9,
      categories: ['Massas', 'Prato Principal'],
    },
    {
    ...
    },
    {
      ...
      description:
        'Filé de frango grelhado com molho de ervas e batatas rústicas.',
      price: 32.9,
      categories: ['Carnes', 'Prato Principal'],
    },
    {
  ...
  const dishesData3 = [
    {
      name: 'Xis Carne',
      description:
        'Pão de hambúrguer com carne, alface, tomate, cebola, queijo e maionese.',
      price: 18.9,
    ...
    },
    {
      name: 'Xis Frango',
      description:
        'Pão de hambúrguer com filé de frango, alface, tomate, cebola, queijo e maionese.',
      price: 17.9,
      categories: ['Xis', 'Lanches'],
    },
    {
      name: 'Xis Calabresa',
      description:
        'Pão de hambúrguer com calabresa, alface, tomate, cebola, queijo e maionese.',
      price: 19.9,
      categories: ['Xis', 'Lanches'],
    },
    {
      name: 'Xis Bacon',
      description:
        'Pão de hambúrguer com carne, bacon crocante, alface, tomate, cebola, queijo e maionese.',
      price: 22.9,
      categories: ['Xis', 'Lanches'],
    },
    {
      name: 'Xis X-Tudo',
      description:
        'Pão de hambúrguer com carne, presunto, queijo, ovo, alface, tomate, cebola, milho e maionese.',
      price: 24.9,
      categories: ['Xis', 'Lanches'],
    },
    {
      ...
      description:
        'Pão de hambúrguer com hambúrguer de soja, alface, tomate, cebola, queijo e maionese.',
      price: 20.9,
    ...
    },
    {
      ...
      description:
        'Pão de hambúrguer com carne, alface, tomate, cebola, queijo e molho especial.',
      price: 16.9,
    ...
    },
    {
      ...
      description:
        'Pão de hambúrguer com duas carnes, alface, tomate, cebola, queijo e molho especial.',
      price: 21.9,
      categories: ['Hambúrgueres', 'Lanches'],
    },
    {
      ...
      description:
        'Pão de hambúrguer com filé de frango, alface, tomate, cebola, queijo e molho especial.',
      price: 15.9,
      categories: ['Hambúrgueres', 'Lanches'],
    },
    {
      ...
      description:
        'Pão de cachorro quente com salsicha, purê de batata, milho, ervilha, queijo ralado e molhos.',
      price: 12.9,
      categories: ['Lanches'],
    },
    {
      ...
      description:
        'Pão de cachorro quente com duas salsichas, purê de batata, milho, ervilha, queijo ralado e molhos.',
      price: 16.9,
      categories: ['Lanches'],
    },
    {
    ...
    },
    {
      ...
      description:
        'Porção de batatas fritas com queijo cheddar derretido e bacon.',
      price: 18.9,
      categories: ['Acompanhamentos', 'Petiscos'],
    },
    {
